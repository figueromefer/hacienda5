<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">Actualiza la información de tu perfil y tu correo electrónico.</p>
    </header>
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    ...
                    @if (session('status') === 'verification-link-sent')
                        <p class="mt-2 font-medium text-sm text-green-600">Se envió un nuevo enlace de verificación a tu correo.</p>
                    @endif
                </div>
            @endif
        </div>
